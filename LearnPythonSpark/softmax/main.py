...
sys.path.append("E:\workspace\LearningSpark\LearnPythonSpark\softmax\iohelper.py")
...
if __name__ == '__main__':
    ...
    iohelp = IOHelper()
    raw_data_df = iohelp.read(tableName="train")
    data = raw_data_df.toPandas()
    ...
    iohelp.write(iohelp.getSparkSession.createDataFrame(pd.DataFrame(test_predict)))
    time_4 = time.time()
